...
const Profile = () => {
  ...
  const callAboutpage = async () => {
    try {
      ...
      const res = await axios.post("http://localhost:5000/profile", { token });
       ...
       <h4>Registration : {userData.registration}</h4>
        ...
        <div className="timeline">
         <div className="user_post">
           <h3>First Post</h3>
           <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum culpa eum nobis incidunt maxime possimus natus, ex vel itaque iste?</p>
         </div>
         <div className="user_post">
           <h3>Second Post</h3>
           <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum culpa eum nobis incidunt maxime possimus natus, ex vel itaque iste?</p>
